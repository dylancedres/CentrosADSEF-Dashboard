...
def create_dashboard(counties, sdoh):
    ...
    labels_for_counties = ["Families with public income \ food assistance",  # poverty
    ...
    descriptions_for_counties = [
        "Percentage of households with public assistance income or food stamps/SNAP (ZCTA level)",  # poverty
    ...
    mapp = px.choropleth(data_frame=sdoh,  # dataframe to use
                         ...
                         color_continuous_scale=pc.sequential.Plasma,  # color scale for color intensities
    ...
    mapp.update_geos(bgcolor="lightblue")  # map background color
    ...
    mapp.update_layout(margin=dict(r=0, t=0, l=0, b=0),  # Application Boundaries
                       ...
                       paper_bgcolor="white",  # application background color
                       ...
                       title=dict(  # Main Title Design
                           ...
                           text="Puerto Rico <br>"  # 
                                "Standart Derterminant Of Health <br>Kidney Disease",
                       ...
                       legend=dict(  # Legend Design
                           ...
                           itemwidth=35,  # size of symbols inside the legend
    ...
    # size_max=,                                                 # sets maximum size dots can have
    ...
    st.plotly_chart(mapp,
                    ...
                    config={"displayModeBar": "hover",
                            # Sets the mode bar to appear only when the mouse is inside the plot
...
# Call the functions
counties, sdoh = load_data()
create_dashboard(counties, sdoh)
