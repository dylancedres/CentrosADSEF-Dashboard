...
# sdoh_options = ["ACS_PCT_INC50_ABOVE65",          # poverty
...
#                 "ACS_PCT_COLLEGE_ASSOCIATE_DGR",  # education
...
#                 "ACS_PCT_POSTHS_ED",
#                 "ACS_TOT_CIVIL_EMPLOY_POP",       # employment
#                 "ACS_PCT_UNINSURED",              # insurance coverage
#                 "HIFLD_MIN_DIST_UC",              # healthcare access
#                 "POS_MIN_DIST_ED",
#                 "POS_MIN_DIST_ALC",
#                 "ACS_PCT_DISABLE",                # disability
#                 "ACS_PCT_NONVET_DISABLE_18_64",
#                 "ACS_PCT_VET_DISABLE_18_64",
#                 "MMD_ANXIETY_DISD",               # mental health
#                 "MMD_DEPR_DISD"]        
...
# descriptions_for_counties = [
#     "Percentage of population with income to poverty ratio under 0.50 (ages 65 and over).",  # poverty
#     "Percentage of population under 1.37 of the poverty threshold (relevant for health insurance coverage).",
#     "Percentage of population between 1.38 and 1.99 of the poverty threshold (relevant for health insurance coverage).",
#     "Percentage of population between 2.00 and 3.99 of the poverty threshold (relevant for health insurance coverage).",
#     "Percentage of population over 4.00 of the poverty threshold (relevant for health insurance coverage).",
#     "DONEPercentage of Families that receive Public Assistance Income or Food Stamps/SNAP (Supplemental Nutrition Assistance Program).",
#     "Percentage of population with some college or associate's degree (ages 25 and over).",  # education
...
#     "DONEPercentage of People With Less Than a High School Education (Ages 25 and over).",
#     "Percentage of population with any postsecondary education (ages 25 and over).",
#     "DONENumber (Thousands) of Employed Civilians (Ages 16 and over).",  # employment
#     "DONEPercentage of People Without Health Insurance Coverage..",  # insurance converage
#     "DONEPercentage of People Without Health Insurance Coverage.",  # healthcare access
#     "Minimum distance in miles to the nearest emergency department, calculated using population weighted tract centroids in the county.",
#     "Minimum distance in miles to the nearest hospital with alcohol and drug abuse inpatient care, calculated using population weighted tract centroids in the county.",
#     "Percentage of population with a disability.",  # disability
#     "Percentage of nonveterans with a disability (between ages 18 and 64).",
#     "Percentage of civilian veterans with a disability (between ages 18 and 64).",
#     "Prevalence of anxiety disorders among Medicare (dual and non-dual) beneficiaries.",  # mental health
